...
export function OrdersFilters({
    ...
    return (
        <div className="w-full bg-white rounded-xl border border-purple-100 shadow-sm p-4 sm:p-6">
            {/* Header */}
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="font-bold text-gray-900">Filtros de Pesquisa</h3>
                        <p className="text-xs text-gray-500">Refine sua busca por pedidos</p>
                    </div>
                </div>
                {hasActiveFilters && (
                    <span className="bg-purple-100 text-purple-700 text-xs font-semibold px-3 py-1 rounded-full animate-pulse">
                        Filtros Ativos
                    </span>
                )}
            </div>
